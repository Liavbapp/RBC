...
class Tests(unittest.TestCase):
    ...
    def test_betweeness_policy(self):
        graphs = GraphGenerator('SPBC').same_num_nodes_same_num_edges_diffrent_graphs(num_nodes=12, num_edges=20)
        ...
        for graph, r, t, rbc in zip(graphs, Rs, Ts, RBCs):
            ...
            root_path = r'C:\Users\LiavB\OneDrive\Desktop\Msc\Thesis\Experiments\Experiments_5'
            save_path = Saver.get_saving_matrix_path(Centralities.SPBC, adj_matx, root_path)
            Saver.save_matrices(adj_matrix=adj_matx, routing_policy=r, traffic_matrix=t, rbc_vector=rbc, path=save_path)
