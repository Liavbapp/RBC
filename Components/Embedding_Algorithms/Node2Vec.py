...
# https://karateclub.readthedocs.io/en/latest/_modules/karateclub/node_embedding/neighbourhood/node2vec.html
...
class Node2Vec(Estimator):
    ...
    def __init__(self, walk_number: int = 10, walk_length: int = 80, p: float = 1.0, q: float = 1,
